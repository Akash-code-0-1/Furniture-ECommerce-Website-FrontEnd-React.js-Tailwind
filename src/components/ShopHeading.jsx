        ...
        <div class=" bg-[#F9F1E7] mb-10">
            ...
            >
                ...
                <div class="relative flex justify-center text-center items-center">
                    ...
                    <p class='font-poppins text-[16px] font-light text-black'>Shop</p>
                </div>
            </div>


            {/* Control Section  */}
            <div class="mt-8 flex flex-wrap items-center justify-around space-y-4 sm:space-y-0 pb-4 bg-[#F9F1E7]">
                {/* Left Controls  */}
                <div class="flex items-center space-x-4">
                    <button class="flex items-center px-3 py-2 text-black">
                        ...
                        <span class="ml-6 text-[20px] font-poppins">Filter</span>
                    </button>
                    <button class="p-2 ">
                    ...
                    <div className="line h-[37px] w-[2px] bg-slate-500">

                    </div>
                    <p class="text-[16px] text-black">Showing 1-16 of 32 results</p>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-2">
                        <label class="text-[20px] font-poppins font-medium text-black">Show</label>
                        <select class="w-16 h-14 px-3 py-1 text-[#9F9F9F] text-[20px] font-poppins">
                            <option>16</option>
                            <option>32</option>
                            <option>64</option>
                        </select>
                    ...
                    <div class="flex items-center space-x-2">
                        <label class="text-[20px] font-poppins font-medium text-black">Sort by</label>
                        <select class="px-2 h-14 py-1 text-[#9F9F9F] text-[20px] font-poppins">
