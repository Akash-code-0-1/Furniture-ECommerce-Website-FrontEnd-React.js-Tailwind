...
import menu_bar from '../images/navbar/menu_bar.png';

const Navbar = () => {
    return (
        <nav className="flex justify-between lg:justify-around p-2 md:h-[100px] w-full md:p-2">

            {/* left Section */}
            <div className="logo flex items-center text-center">
                <div className="logo_container flex text-center  justify-center items-center">
                    <img className="h-[28px] w-[45px] md:h-[28px] md:w-[50px] lg:h-[32px] lg:w-[50px]" src={logo} alt="" />
                    <h1 className="text-black font-montserrat text-[30px] md:text-[30px] lg:text-[34px] font-bold leading-normal">Furniro</h1>
                </div>

            </div>

            {/* Middle Section */}
            <div className="page_links  hidden md:flex md:block md:text-center md:justify-center md:items-center md:gap-8 lg:gap-10">
                <NavLink to="/" className={({ isActive }) => (isActive ? "text-primary" : "")}>Home</NavLink>
                <NavLink to="/shop" className={({ isActive }) => (isActive ? "text-primary" : "")}>Shop</NavLink>
            ...
            {/* right section */}
            <div className="right_section hidden md:block md:flex md:text-center  md:justify-center md:items-center md:gap-3 lg:gap-6">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                    <path d="M24.5 24.5L19.2663 19.257M22.1666 12.25C22.1666 14.88 21.1219 17.4024 19.2621 19.2621C17.4024 21.1219 14.88 22.1666 12.25 22.1666C9.61992 22.1666 7.09757 21.1219 5.23784 19.2621C3.3781 17.4024 2.33331 14.88 2.33331 12.25C2.33331 9.61992 3.3781 7.09757 5.23784 5.23784C7.09757 3.3781 9.61992 2.33331 12.25 2.33331C14.88 2.33331 17.4024 3.3781 19.2621 5.23784C21.1219 7.09757 22.1666 9.61992 22.1666 12.25V12.25Z" stroke="black" stroke-width="2" stroke-linecap="round" />
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                    <path d="M8.16668 3.5C4.94551 3.5 2.33334 6.08533 2.33334 9.275C2.33334 11.8498 3.35418 17.9608 13.4027 24.1383C13.5827 24.2479 13.7893 24.3058 14 24.3058C14.2107 24.3058 14.4173 24.2479 14.5973 24.1383C24.6458 17.9608 25.6667 11.8498 25.6667 9.275C25.6667 6.08533 23.0545 3.5 19.8333 3.5C16.6122 3.5 14 7 14 7C14 7 11.3878 3.5 8.16668 3.5Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
            ...
            <div className="menubar flex md:hidden items-center">
                <img className="h-9" src={menu_bar} alt="" />
            </div>
        </nav>
    );
};
